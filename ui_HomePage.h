...
public:
    ...
    void setupUi(QMainWindow *HomePage)
    {
        ...
        gridLayoutWidget->setGeometry(QRect(390, 80, 171, 131));
        ...
        Image_holder->setGeometry(QRect(30, 65, 331, 481));
    ...
    void retranslateUi(QMainWindow *HomePage)
    {
        ...
        label_3->setText(QApplication::translate("HomePage", "Enter Number of Views :", Q_NULLPTR));
